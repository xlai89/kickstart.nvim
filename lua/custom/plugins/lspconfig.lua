return { -- LSP Configuration & Plugins
  ...
  config = function()
    ...
    if require('nixCatsUtils').isNixCats then
      -- Cannot require('java') here for nvim-java because its dependency "mason.ui" is not available or allowed.
      ...
      for server_name, _ in pairs(servers) do
        ...
        -- skip jdtls, which is currently configured by nvim-java, which needs mason
